...
class PuzzleCache2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            inputValue: '',
    ...
    customPieces = () => {
        if (!this.showPiece) {
            ...
            roiBlanc.map((p) => {
                returnPieces[p] = ({ squareWidth }) => (
                    <img src="https://i.imgur.com/QrtQiLp.png" alt="roi" style={{ width: squareWidth, height: squareWidth }}></img>
                );
                return null;
            });
            return returnPieces;
